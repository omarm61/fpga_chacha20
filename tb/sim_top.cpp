...
int main(int argc, char** argv)
{
    ...
    m_Sim.AxiWrite(TX_AXI_PRBS_SEED, seed); // Write PRBS seed 
    ...
    m_Sim.Validate32Bit(seed, rdata, "Configure TX");

    // --------------
    // Configure RX
    // --------------
    // Write SEED and enable module
    m_Sim.AxiWrite(RX_AXI_PRBS_SEED, seed); // Write PRBS seed 
    ...
    m_Sim.Validate32Bit(seed, rdata, "Configure RX");
